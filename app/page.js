      ...
      <section className='bg-[#254f1a] min-h-[100vh] grid grid-cols-2'>
        ...
        <div className="flex justify-center flex-col ml-[10vw] gap-3 ">
          ...
          <div className="input flex gap-2">
            <input value={text} onChange={(e) => setText(e.target.value)} className="py-2 px-2 bg-white focus:outline-green-800 rounded-md" type="text" placeholder="Enter your Handle" />
            <button onClick={() => createTree()} className="bg-pink-300 rounded-full px-4 py-4 font-semibold">Claim your BitTree</button>
          </div>

        </div>

        <div className=" flex items-center justify-center flex-col mr-[10vw] min-h-1.5">
          <img src="/Home.jpg" height={200} width={450} alt="homepage image" srcset="" />
        </div>
